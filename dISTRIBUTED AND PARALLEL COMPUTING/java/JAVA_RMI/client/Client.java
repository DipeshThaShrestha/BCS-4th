...
public class Client {
    ...
    try {
        ...
        Product mobile = (Product) registry.lookup("ram");
        ...
        // For mobile 
        System.out.println("The name of mobile is " + mobile.getName());
        System.out.println("The description of mobile is " + mobile.getDescription());
        System.out.println("The price of mobile is " + mobile.getPrice());
